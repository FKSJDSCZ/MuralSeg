...
__all__ = [
    ...
    'MultiImageMixDataset', 'iSAIDDataset', 'ISPRSDataset', 'PotsdamDataset', 'KizilDataset',
    ...
    'NYUDataset', 'HSIDrive20Dataset', 'MuralDHDataset',
]
