...
class FeedFormerHead(BaseDecodeHead):
    """
    FeedFormer decode head.

    This decode head is the implementation of `FeedFormer: Revisiting Transformer Decoder for Efficient Semantic Segmentation
    <https://doi.org/10.1609/aaai.v37i2.25321>`_.
    """
    ...
    def __init__(self, feature_strides, **kwargs):
        ...
        self.attn_c4_c1 = Block(
            dim1=c4_in_channels, dim2=c1_in_channels, num_heads=8, mlp_ratio=4,
            drop_path=0.1, pool_ratio=8,
        )
        self.attn_c3_c1 = Block(
            dim1=c3_in_channels, dim2=c1_in_channels, num_heads=5, mlp_ratio=4,
            drop_path=0.1, pool_ratio=4,
        )
        self.attn_c2_c1 = Block(
            dim1=c2_in_channels, dim2=c1_in_channels, num_heads=2, mlp_ratio=4,
