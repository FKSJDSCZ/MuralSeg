...
model = dict(  # Runner arg
    ...
    decode_head=dict(
        ...
        source_indices=[
            [0, 1, 2, -1],  # stage 0 (H/4):  add Z1,Z2 for richer global context
            [0, 1, 2, -1],  # stage 1 (H/8):  add Z2
            [1, 2, 3, -1],  # stage 2 (H/16): focus on mid/high-level
            [2, 3],  # stage 3 (H/32): avoid very high-res noise
        ],
