...
model = dict(  # Runner arg
    ...
    decode_head=dict(
        ...
        agent_pool_sizes=((7, 7), (7, 7), (7, 7), (7, 7)),
        kv_agent_pool_sizes=((7, 7), (7, 7), (7, 7), (7, 7)),
        use_kv_agent=True,
        use_learnable_agent=False,
        use_ortho_agent=True,
        ortho_eps=1e-4,
        # Boundary tokens
        boundary_pool_size=None,
        boundary_lowpass_kernel=3,
        boundary_eps=1e-6,
        boundary_use_abs=True,
        # Local DWConv in attention / MLP
        use_dwconv_attn=True,
        dwconv_attn_kernel_size=3,
        dwconv_mlp_kernel_size=3,
        # CatKey
        share_cat_key=False,
